...
<body class="overlay-scrollbar">
    ...
    <div class="dashwrapper animated fadeIn">
        <div class="container-fluid">
            <h6 class="mt-1 badge badge-pill badge-light tag-hover" style="padding: 10px; font-size: 0.75rem;">Account Holder : <a href="profile.php"><?php echo $_SESSION['mtd_email']; ?></a></h6>
