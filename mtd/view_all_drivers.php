...
<head>
    <title>View Drivers | RATSA</title>
	...
	<div class="modal fade" id="add_data_Modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="../mtd/view_all_drivers_edit_modal.php" method="POST" id="editDriverForm">
...
/*				success:function(data){ 					
      ...
      $(document).on('click', '.edit_data', function(){  
           var did = $(this).attr("id");  
           $.ajax({  
                url:"../mtd/view_all_drivers_edit_modal_formdata.php",  
                method:"POST",  
                data:{did:did},  
                dataType:"json",  
                success:function(data){  
