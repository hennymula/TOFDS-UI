...
<head>
    <title>TOFDS Traffic-Police-Officer | Login</title>
    <!--Meta tags start-->
    <meta charset="UTF-8">
            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body animated fadeIn">
                        ...
                        <h5 class="card-title text-center">Traffic Police Officer</h5>
                        <!--Warning msg start-->
				...
				<?php } ?>
                        <form class="form-signin" action="../tpo/login_action.php" method="POST">
