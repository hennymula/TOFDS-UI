                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="driver_name" placeholder="Court" value="<?php echo $row['court']; ?>" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="amount">Registered Date</label>
                                <input type="text" class="form-control" id="email" placeholder="Registered Date" value="<?php echo $row['registered_at']; ?>" disabled>
                            </div>
                        </div>
                                </form>
                                <?php
