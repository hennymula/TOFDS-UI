...
<body class="overlay-scrollbar">
    ...
    <div class="container-fluid" style="margin-top: 100px; padding: 0 4rem 3rem 4rem;">
        <h1 class="heading">How to use TOFDS?</h1>
        <hr></hr>
            ...
            <div class="container animated fadeIn">
                <div class="row">
                    <div class="footer-col">
                        <h4>NEED HELP?</h4>
                        <ul>
                            <li><a href="tel:+94714590248"><i class="fas fa-phone"></i>+260777002968</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>EMAIL US</h4>
                        <ul>
                            <li><a style="text-transform: lowercase;" href="mailto:crafthouse@gmail.com" target="_blank"> <i class="fas fa-envelope"></i>TOFDS@gmail.com</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Get help</h4>
                        ...
                        <ul>
                            <li><a href="gov.php">RATSA LOGIN</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
