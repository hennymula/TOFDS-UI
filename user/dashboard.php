...
<body class="overlay-scrollbar">
    ...
    <div class="dashwrapper animated fadeIn">
        <div class="container-fluid">
            <h6 class="mt-1 badge badge-pill badge-light tag-hover" style="padding: 10px; font-size: 0.75rem;">Driver Name : <a href="profile_details.php"><?php echo $_SESSION['driver_name']; ?></a></h6>
            <!--Main four count boxes start here-->
            <div class="row p-2">
                 <!--zero count box start-->
                 <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 animated fadeIn">
                    <div data-toggle="tooltip" data-placement="bottom" data-title="Number of court orders you have to attend" class="dashcounter color-three p-4 box-hover">
                        <p>
                        ...
                        <?php
                            ...
                            $query = "SELECT ref_no FROM issued_fines WHERE license_id='$license_id' AND status='court order' "; 
                            $query_run = mysqli_query($conn, $query);

                            $row = mysqli_num_rows($query_run);
                            echo '<h3 class="counter">'.$row.'</h3>';
                        ?>
                        <p class="dashcount-name">Court Orders Count</p>
                    </div>
                </div>
                <!--zero count box end-->
