...
<head>
    <title>Driver's Violation | Driver</title>
...
<body class="overlay-scrollbar">
    ...
    <div class="dashwrapper">
            <div class="container-fluid">
                <h1 class="mt-4">Driver's Violations</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active">Driver's Violations</li>
                </ol>
                <div class="card mb-4">
    ...
    <!--View Drivers popup modal includes goes here-->
    <?php 
