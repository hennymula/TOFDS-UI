...
<Footer class="fixed-footer"style="center">
<p>©  
<?php echo date("Y"); ?>
Traffic Offence and Fine Detection System - A Final Year Project Developed By 
<span style="color: white">Hendricks Mwape(201902471)</span>
</p> 
    </Footer>>
