...
<head>
    <title>View Traffic Officers | TOFDS Admin</title>
...
<body class="overlay-scrollbar">
    ...
    <div class="dashwrapper">
            <div class="container-fluid">
                <h1 class="mt-4">View Traffic Officers</h1>
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                    <li class="breadcrumb-item active">View Traffic Officers</li>
                </ol>
                <div class="card mt-5 mb-4">
                    <div class="card-header">
                        <i class="fas fa-table mr-1"></i> You can sort data here
                    </div>
					<!--View Traffic Officers - get data to main table-->
					<?php
                    ...
                    <div class="card-body">
                        <div class="table-responsive" id="employee_table">
                            <!--View Traffic Officers table view goes here-->
    ...
    <!--View Traffic Officers popup modals-->	
	...
	<script>
      ...
      $(document).on('click', '.edit_data', function(){  
           ...
           $.ajax({  
                url:"../admin/view_all_traffic_officers_edit_modal_formdata.php",  
                method:"POST",  
                data:{did:did},  
                dataType:"json",  
      ...
      $('#insert_form').on("submit", function(event){  
           ...
           { 
                $.ajax({  
                     url:"../admin/view_all_traffic_officers_edit_modal.php",  
                     method:"POST",  
        ...
        {
            $.ajax({
               url:"../admin/view_all_traffic_officers_delete.php",  
               type: "POST",
               data:{did:did},    
               error: function() {
