...
<head>
    <title>Dashboard | TOFDS Admin</title>
   ...
   <div class="leftsidebar" id="sidebar">
    ...
    <div class="dashwrapper animated fadeIn">
        <div class="container-fluid">
            <h6 class="mt-1 badge badge-pill badge-light tag-hover" style="padding: 10px; font-size: 0.75rem;">Account Holder : <a href="profile.php"><?php echo $_SESSION['admin_email']; ?></a></h6>
            ...
            <div class="row p-2">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 animated fadeIn">
                    <div data-toggle="tooltip" data-placement="bottom" data-title="Total amount of pending fine" class="dashcounter color-two p-4 box-hover">
                        ...
                        $total = $row[0];
                       echo '<h3 class="counter">'.number_format($total).'</h3>'; 
                        ?>                 
                        <p class="dashcount-name">Pending Fine Amount (ZMK)</p>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 animated fadeIn">
                    <div data-toggle="tooltip" data-placement="bottom" data-title="Total amount of paid fine" class="dashcounter color-four p-4 box-hover">
                        ...
                        ?>
                        <p class="dashcount-name">Paid Fine Amount (ZMK)</p>
                    </div>
                </div>
                <!--Third count box end-->
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 animated fadeIn">
                    <div data-toggle="tooltip" data-placement="bottom" data-title="Provisions count in system" class="dashcounter color-three p-4 box-hover">
                        ...
                        <?php
                            ...
                            echo '<h3 class="counter">'.$row.'</h3>';
                        ?>
                        <p class="dashcount-name">Violations Count</p>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 animated fadeIn">
                    <div data-toggle="tooltip" data-placement="bottom" data-title="All the number of police stations" class="dashcounter bg-success p-4 box-hover">
                        ...
                        <?php
                            include "../connection.php";
                            $query = "SELECT police_station FROM tpo"; 
                            $query_run = mysqli_query($conn, $query);
                ...
                <!--Sixth count box end-->
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-xs-12 animated fadeIn">
    <div data-toggle="tooltip" data-placement="bottom" data-title="Total number of valid licenses" class="dashcounter color-three p-4 box-hover">
        <p>
            <i class="fas fa-id-card"></i>
        </p>
        <?php
        include ("../connection.php");
        $query = "SELECT COUNT(*) AS valid_license FROM revenue_license WHERE expire_date >= CURDATE()";
        $result = mysqli_query($conn, $query);
        $row = mysqli_fetch_assoc($result);
        $validLicenses = $row['valid_license'];
        echo '<h3 class="counter">'.$validLicenses.'</h3>';
        ?>
        <p class="dashcount-name">Valid Road Tax</p>
    </div>
</div>
            </div>
...
<script>
    ...
    type: 'doughnut',
    data: {
      labels: ["Paid Fine Amount (ZMK)", "Pending Fine Amount (ZMK)"],
      datasets: [
        {
