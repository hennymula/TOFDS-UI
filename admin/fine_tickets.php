...
<head>
    <title>Fines & Violations | TOFDS Admin</title>
    ...
    <div class="dashwrapper">
            <div class="container-fluid">
                ...
                <div class="card-header">
                    <i class="fas fa-receipt"></i> Add Violation Details
                </div>
                <div class="card-body" style="margin:0 2rem 1rem 2rem;">
                <form action="../admin/fine_tickets_action.php" method="POST">

                <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="section_of_act">Fine ID</label>
                    <input type="text" class="form-control" id="fine_id" value="<?php echo (isset($_GET['fineid']))? $_GET['fineid'] : ''; ?>" name="fineid" placeholder="Fine ID">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                    <label for="provision">Violations</label>
                    <input type="text" class="form-control" id="provision" value="<?php echo (isset($_GET['provision']))? $_GET['provision'] : ''; ?>" name="provision" placeholder="Violations">
                </div>
                <div class="form-group col-md-6">
                    <label for="fine_amount">Fine Amount(K)</label>
            ...
            <button type="submit" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Add Fine Ticket</button>
                ...
                <div class="card mt-5 mb-4">
                    <div class="card-header">
                        <i class="fas fa-table mr-1"></i> All Fines and Violations Details
                    </div>
                    <div class="card-body">
            ...
            <div class="modal-body">
                <form id="insert_form" method="POST">
                    <div class="form-group">
                        <label for="fine_idm">Fine ID</label>
                        <input type="text" class="form-control" name="fine_idm" id="fine_idm" placeholder="Fine ID">
                    </div>
                    <div class="form-group">
                        <label for="section_of_actm">Section of Act</label>
                        <input type="text" class="form-control" name="section_of_actm" id="section_of_actm" placeholder="Section of Act">
                    </div>
                    <div class="form-group">
                        <label for="provisionm">Violoation</label>
                        <input type="text" class="form-control" name="provisionm" id="provisionm" placeholder="Provision">
                    </div>
                    <div class="form-group">
                        <label for="fine_amountm">Fine Amount</label>
...
/*				success:function(data){ 					
      ...
      $(document).on('click', '.edit_data', function(){  
           var did = $(this).attr("id");  
           $.ajax({  
                url:"../admin/fine_tickets_edit_modal_formdata.php",  
                method:"POST",  
                data:{did:did},  
                dataType:"json",  
                success:function(data){ 
                    console.log(data); // Debugging statement to log the response
      ...
      $('#insert_form').on("submit", function(event){  
           ...
           { 
                $.ajax({  
                     url:"../admin/fine_tickets_edit_modal.php",  
                     method:"POST",  
                     data:$('#insert_form').serialize(),  
                     beforeSend:function(){  
                          $('#insert').val("Inserting");  
        ...
        {
            $.ajax({
               url:"../admin/fine_tickets_delete_modal.php",  
               type: "POST",
               data:{did:did},    
                     error: function(jqXHR, textStatus, errorThrown) {
                     console.error("AJAX Error: " + textStatus + ": " + errorThrown); // Debugging statement for errors
                     alert("An error occurred while updating fine details."); // Alert for user feedback
