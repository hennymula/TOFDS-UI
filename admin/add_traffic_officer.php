...
<head>
    <title>Add Traffic Officer | TOFDS Admin</title>
            ...
            <div class="container-fluid">
				...
				<div class="card mb-4">
					<div class="card-body p-lg-5">
						<form action="../admin/add_traffic_officer_action.php" method="POST">
							<div class="form-row">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									...
									<input type="text" class="form-control" id="court" name="tpocourt" value=" <?php echo 'Surbodinate Court'; ?>" placeholder="Court" disabled>
								</div>
								<div class="form-group col-md-6">
